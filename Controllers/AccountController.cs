...
// {
//     private UserManager<AppUser> _userManager;  // Kullanıcı oluşturma.
//     private SignInManager<AppUser> _signInManager;  // Giriş işlemleri bu metot ile yapılır.
...
//             if (user != null)
//             {
//                 await _signInManager.SignOutAsync(); // Eski oturumu kapatıyor.
...
//                     ModelState.AddModelError("", $"Hesabınız kitlenti. Lütfen {timeLeft.Minutes + 1} dakika sonra tekrara deneyiniz.");
//                 }
//                 else
//                 {
...
//         if (user == null)
//         {
//             TempData["Mesaj"] = "Bu eposta adresi kayıtlı değildir";
//             return View();
//         }
...
//         var link = $"<a href='Http://localhost:5045{url}'> Şifre Yenile </a>";

//         await _emailService.SendEmailAsync(user.Email!, " Parola Sıfırlama", link);

//         TempData["Mesaj"] = "Bu eposta adresine gönderilen link ile şifreni sıfırlayabilirsin";
...
public class AccountController : Controller
{
    ...
    public async Task<ActionResult> ForgotPassword(string email)
    {
        ...
        var link = $"<a href='{url}'> Şifre Yenile </a>";
