...
namespace my_dotnet_store.Migrations
{
    ...
    [Migration("20260123090609_AddOrderTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("my_dotnet_store.Models.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("my_dotnet_store.Models.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("my_dotnet_store.Models.Cart", b =>
                {
            ...
            modelBuilder.Entity("my_dotnet_store.Models.CartItem", b =>
                {
            ...
            modelBuilder.Entity("my_dotnet_store.Models.Kategori", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("my_dotnet_store.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("my_dotnet_store.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("my_dotnet_store.Models.Slider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("my_dotnet_store.Models.Urun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("my_dotnet_store.Models.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("my_dotnet_store.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("my_dotnet_store.Models.CartItem", b =>
                {
                    b.HasOne("my_dotnet_store.Models.Cart", "Cart")
                        .WithMany("CartItems")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("my_dotnet_store.Models.Urun", "Urun")
                        .WithMany()
            ...
            modelBuilder.Entity("my_dotnet_store.Models.OrderItem", b =>
                {
                    b.HasOne("my_dotnet_store.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("my_dotnet_store.Models.Urun", b =>
                {
                    b.HasOne("my_dotnet_store.Models.Kategori", "Kategori")
                        .WithMany("Uruns")
